...
# Generate a random selection of lines from the corpus to ensure a group of smaller and longer sentences.
random_lines = random.sample(lines, n_corpus_lines)
random.seed(42)
...
for line in random_lines[:n_corpus_lines]:    # For each line in first N lines
